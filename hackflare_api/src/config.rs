...
pub fn from_env() -> Result<Config> {
    ...
    Ok(Config {
        bind_addr: env_or("API_BIND_ADDR", "0.0.0.0:8080".parse().expect("invalid default API bind address"))?,
        dns_bind_addr: env_or("API_DNS_BIND_ADDR", "0.0.0.0:5353".parse().expect("invalid default DNS bind address"))?,
