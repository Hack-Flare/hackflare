...
config :hackflare, HackflareWeb.Endpoint,
  ...
  watchers: [
    ...
    tailwind: {Tailwind, :install_and_run, [:hackflare, ~w(--watch)]}
  ]
...
config :hackflare, HackflareWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/hackflare_web/router\.ex$"E,
      ~r"lib/hackflare_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :hackflare, dev_routes: true
